...
# Cache simple para consultas frecuentes (mejora rendimiento con DB lenta)
_query_cache = {}
...
def normalize_postgres(sql: str, user_question: str = "") -> str:
    ...
    # Optimización: limitar consultas pesadas en v_games
    if re.search(r'\b(best|top|highest)\b', s, flags=re.I) and "FROM v_games" in s:
        # Añadir filtro para mejorar rendimiento
    ...
    # OPTIMIZACIÓN CRÍTICA: Límites estrictos para DB lenta
